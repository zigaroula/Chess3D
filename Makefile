...
SOURCES=main.cpp vao.cpp scene.cpp program.cpp shader.cpp application.cpp camera.cpp game.cpp board.cpp player.cpp piece.cpp pawn.cpp rook.cpp knight.cpp bishop.cpp queen.cpp king.cpp tga.cpp
